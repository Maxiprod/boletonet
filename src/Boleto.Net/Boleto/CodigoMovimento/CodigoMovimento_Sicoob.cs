    ...
    public class CodigoMovimento_Sicoob : AbstractCodigoMovimento, ICodigoMovimento
    {
        ...
        private void carregar(int codigo)
        {
            try
            {
                ...
                switch (movimento)
                {
                    case EnumCodigoMovimento_Sicoob.ConfirmacaoInstrucaoTransferenciaCarteiraModalidadeCobrança:
                        this.Codigo = (int)EnumCodigoMovimento_Sicoob.EntradaConfirmada;
                        break;
                }

                this.Descricao = descricoes[movimento];
            }
            catch (Exception ex)
            {
        ...
        private Dictionary<EnumCodigoMovimento_Sicoob, TipoOcorrenciaRetorno> correspondentesFebraban = new Dictionary<EnumCodigoMovimento_Sicoob, TipoOcorrenciaRetorno>()
        {
            ...
            { EnumCodigoMovimento_Sicoob.ConfirmacaoInstrucaoTransferenciaCarteiraModalidadeCobrança    ,TipoOcorrenciaRetorno.ConfirmacaoDeinstrucaoDetransferenciaDecarteiraModalidadeDecobrança},
        };
        ...
        private Dictionary<EnumCodigoMovimento_Sicoob, string> descricoes = new Dictionary<EnumCodigoMovimento_Sicoob, string>()
        {
            ...
            { EnumCodigoMovimento_Sicoob.ConfirmacaoInstrucaoTransferenciaCarteiraModalidadeCobrança    , "Confirmação de instrução de transferência de carteira/modalidade de cobrança"    }
        };
        #endregion
    }
}
